...
enum AudioExtractor {
    ...
    static func extractAudio(
        ...
        do {
            ...
            let sampleRate = basicDesc?.pointee.mSampleRate ?? 48_000
            ...
            if let bwfStartTimecode {
                try BroadcastWaveInjector.inject(
                    url: outputURL,
                    startTimecode: bwfStartTimecode,
